...
namespace DiscountsSystem.Application.Validation.AdminUsers;

public sealed class CreateCustomerByAdminRequestValidator
    : AbstractValidator<CreateCustomerByAdminRequest>
{
    public CreateCustomerByAdminRequestValidator()
    {
        RuleFor(x => x.FirstName)
            ...
            .WithMessage("First name must contain only Latin letters and single spaces/hyphens (no digits/symbols).");
        ...
        RuleFor(x => x.LastName)
            ...
            .Must(NameRules.BeLatinNameWithSpaceOrHyphen)
            .WithMessage("Last name must contain only Latin letters and single spaces, hyphens (no digits or symbols).");
